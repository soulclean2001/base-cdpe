  ...
  return (
    <div className="footer-container">
        <>
            <Row className="footer-content">
                ...
                <Col md={5}>
                    ...
                    <div><NavLink to="">Tìm việc làm</NavLink></div>
        ...
        <div className="footer-address">
            <span>Copyright © Công Ty Cổ Phần Navigos Group Việt Nam Tầng 20, tòa nhà E.Town Central, 11 Đoàn Văn Bơ, Phường 13, Quận 4, TP.HCM, Việt Nam</span>
        </div>
        <Row className="footer-bottom-container" justify={"center"} align={"middle"}>
            <Col md={4} className="footer-name-web">HFWork</Col>
            <Col md={20}>
